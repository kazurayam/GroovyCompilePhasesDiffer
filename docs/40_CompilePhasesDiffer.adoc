...
2. at the "4 SEMANTIC_ANALYSIS", "5 CANONICALIZATION" and "7 CLASS_GENERATION" phases, the compiler gradually transforms the AST.

3. at the "5 CANONICALIATION" phase, the compiler adds constructors, equals method, toString method

4. at the "7 CLASS_GENERATION" phase, the compiler adds getters
